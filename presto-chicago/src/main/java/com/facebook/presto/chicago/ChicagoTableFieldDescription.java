...
/**
 * Json description to parse a single field from a Chicago key/value row. See {@link ChicagoTableDescription} for more details.
 */
public final class ChicagoTableFieldDescription
{
    ...
    @JsonCreator
    public ChicagoTableFieldDescription(
    ...
    ChicagoColumnHandle getColumnHandle(String connectorId, boolean keyDecoder, int index)
    {
        return new ChicagoColumnHandle(
                connectorId,
                index,
                getName(),
                getType(),
    ...
    public boolean equals(Object obj)
    {
        ...
        ChicagoTableFieldDescription other = (ChicagoTableFieldDescription) obj;
