 ...
 * will be null. Most values are assigned in the {@link ChicagoRecordSet}.
 */
public class ChicagoInternalFieldDescription
{
    /**
     * <tt>_key</tt> - Represents the key as a text column.
     */
    public static final ChicagoInternalFieldDescription KEY_FIELD = new ChicagoInternalFieldDescription("_key", createUnboundedVarcharType(), "Key text");

    /**
     * <tt>_value</tt> - Represents the value as a text column. Format is UTF-8
     */
    public static final ChicagoInternalFieldDescription VALUE_FIELD = new ChicagoInternalFieldDescription("_value", createUnboundedVarcharType(), "Value text");
     ...
     */
    public static final ChicagoInternalFieldDescription VALUE_CORRUPT_FIELD = new ChicagoInternalFieldDescription("_value_corrupt", BooleanType.BOOLEAN, "Value data is corrupt");

    /**
     * <tt>_value_length</tt> - length in bytes of the value.
     */
    public static final ChicagoInternalFieldDescription VALUE_LENGTH_FIELD = new ChicagoInternalFieldDescription("_value_length", BigintType.BIGINT, "Total number of value bytes");
     ...
     */
    public static final ChicagoInternalFieldDescription KEY_CORRUPT_FIELD = new ChicagoInternalFieldDescription("_key_corrupt", BooleanType.BOOLEAN, "Key data is corrupt");

    /**
     * <tt>_key_length</tt> - length in bytes of the key.
     */
    public static final ChicagoInternalFieldDescription KEY_LENGTH_FIELD = new ChicagoInternalFieldDescription("_key_length", BigintType.BIGINT, "Total number of key bytes");

    public static Set<ChicagoInternalFieldDescription> getInternalFields()
    {
    ...
    ChicagoInternalFieldDescription(String name, Type type, String comment)
    {
    ...
    ChicagoColumnHandle getColumnHandle(String connectorId, int index, boolean hidden)
    {
        return new ChicagoColumnHandle(connectorId,
                index,
                getName(),
                getType(),
                null,
    ...
    public boolean equals(Object obj)
    {
        ...
        ChicagoInternalFieldDescription other = (ChicagoInternalFieldDescription) obj;
