...
/**
 * Chicago specific connector column handle.
 * This needs to be adjusted based on the configuration that we needed.
 * This can be used to breakdown complex JSON objects in the key, value columns
 * I don't know if this should be used now. But can be used as a enhancement.
 */
public final class ChicagoColumnHandle implements DecoderColumnHandle, Comparable<ChicagoColumnHandle>
{
  ...
  public boolean equals(Object obj)
  {
    ...
    ChicagoColumnHandle other = (ChicagoColumnHandle) obj;
  ...
  @Override
  public int compareTo(ChicagoColumnHandle otherHandle)
  {
